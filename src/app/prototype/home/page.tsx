...
export default function PrototypeHomePage() {
  return (
    <MagPage
      meta={{
        issue: 'Issue 01 Â· St. Louis, MO',
        folio: 'Folio 001 â€” A new specification',
      ...
      hero={{
        ...
        subtitle:
          'Lower rates. Same-day approval. Real human support â€” in St. Louis, in plain English, on the phone when you need it. For independent merchants who deserve better than the big processors.',
      ...
      threeCards={{
        ...
        cards: [
          ...
          },
          {
            ...
            title: 'A real human',
            description:
              'Call our number and a person picks up â€” in St. Louis, who knows your account. No tier-one queue, no offshore script.',
            image: undefined,
          },
        ],
      }}
      ...
      pullQuote={{
        eyebrow: 'Â§ 03',
        text: '"Switched from Square last quarter. Charm cut my effective rate by {0.4 points} â€” and I have a phone number that actually picks up."',
        citeName: 'Marcus T.',
        citeRole: 'Owner Â· Metro Auto Repair',
        citeLocation: 'St. Louis, MO',
        verifiedDate: 'Verified Â· 03.2026',
      }}
      comparison={{
      ...
      finalCta={{
        ...
        subtitle:
          "Send us your latest processing statement. We'll show you what you've been overpaying â€” and what we'd charge instead. Usually within 24 hours.",
