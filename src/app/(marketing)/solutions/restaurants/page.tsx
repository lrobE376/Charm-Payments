...
export const metadata: Metadata = {
  title: 'Restaurants & Food — Charm Payments',
  description:
    'Restaurants & Food payment processing from Charm Payments. Powered by NMI gateway and First Data/Fiserv acquiring.',
}
  ...
  return (
    <div className="section-ptb">
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <h1 className="font-display mt-6 mb-4 text-4xl font-bold text-brand-dark">Restaurants &amp; Food</h1>
