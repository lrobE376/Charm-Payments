...
const FEATURES = [
  {
    ...
    description:
      'Chip, tap, and swipe from any iOS or Android device. Works on 4G or WiFi. Connects to your NMI merchant account — same settlement, same reporting as your other channels.',
  },
  {
