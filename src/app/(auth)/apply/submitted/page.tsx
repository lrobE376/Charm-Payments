...
export const metadata: Metadata = {
  title: 'Application Submitted â€” Charm Payments',
  description:
  ...
  return (
    <div className="w-full max-w-lg text-center px-4">
      ...
      <p className="text-gray-600 mt-3 leading-relaxed">
        Thank you. Our underwriting team typically reviews new applications within 24â€“48 business hours. You will hear from us by email or phone.
      </p>
