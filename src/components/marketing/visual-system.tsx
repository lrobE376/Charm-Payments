    ...
    <section className={cn('relative overflow-hidden', className)}>
      <div className="mx-auto grid max-w-6xl gap-12 px-6 py-20 md:py-28 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <div className={cn('flex flex-col', copyAlign)}>
          ...
          <h1 className="font-display mt-4 max-w-full whitespace-pre-line text-4xl font-bold text-inherit md:text-5xl lg:text-[3rem]">
            {title}
          </h1>
          <p
            className="mx-auto mt-5 max-w-3xl text-lg leading-relaxed text-inherit opacity-90 lg:mx-0"
            ...
            <div className={cn('mt-10 flex flex-wrap gap-4', actionsAlign)}>
              {primaryCta ? (
                <Link
                  ...
                  className={cn(
                    'inline-flex min-h-[44px] min-w-0 w-full items-center justify-center sm:w-auto',
                    'px-5 sm:px-7',
              ...
              {secondaryCta ? (
                <Link
                  ...
                  className="btn-outline inline-flex min-h-[44px] min-w-0 w-full items-center justify-center px-5 sm:w-auto sm:px-7"
                >
                  {secondaryCta.label}
                </Link>
              ) : null}
